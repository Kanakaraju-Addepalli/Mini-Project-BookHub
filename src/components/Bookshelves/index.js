...
class Bookshelves extends Component {
  ...
  getBooksData = async () => {
    ...
    const {activeShelf, searchValue} = this.state

    const jwtToken = Cookies.get('jwt_token')
    const apiUrl = `https://apis.ccbp.in/book-hub/books?shelf=${activeShelf}&search=${searchValue}`
    const options = {
      method: 'GET',
      headers: {
        ...
        return (
          <div className="book-shelves-failure-view">
            <img
              ...
              src="https://res.cloudinary.com/dbavgpzve/image/upload/v1691989152/Group_7522_m84rff.png"
              alt="failure view"
            />
            <p
          ...
          return (
            <div className="no-books-view-container">
              <img
                ...
                src="https://res.cloudinary.com/dbavgpzve/image/upload/v1691993189/Asset_1_1_ifo1k2.png"
                alt="no books"
              />
              <p
